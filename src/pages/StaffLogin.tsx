      ...
      <div className="max-w-md mx-auto mt-12 card">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input {...register('email', { required: true })} className="w-full mt-1 p-2 rounded bg-background border border-primary" defaultValue="staff@example.com" />
          </div>
          <div>
