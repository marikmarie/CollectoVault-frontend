...
export default function VendorRegisterPage(): JSX.Element {
  const { isAuthenticated, user, register: authRegister } = useAuth() as any;
  ...
  return (
    // <AuthLayout title="Vendor registration" subtitle="Create your vendor account and start listing services">
      <div className="space-y-6">
        {step === "lookup" && (
          <div>
            <p className="text-sm text-slate-300 mb-3">Enter your Collecto ID to fetch registered business details. If you don't have a Collecto ID, you'll need to create one at Collecto first.</p>
